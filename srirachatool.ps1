...
if (!([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    Start-Process -Verb runas -FilePath powershell.exe -ArgumentList "iwr -useb https://raw.githubusercontent.com/winters27/sriracha/main/srirachatool.ps1 | iex"
    break
}
...
function Install-WinUtilWinget {
    ...
    Try{
        ...
        Start-Process -Verb runas -FilePath powershell.exe -ArgumentList "irm https://raw.githubusercontent.com/winters27/sriracha/main/srirachatool.ps1 | iex"
...
Function Invoke-WPFFormVariables {
    ...
    Write-Host "            /`$`$__  `$`$          |__/                             | `$`$                 "
    Write-Host "           | `$`$  \__/  /`$`$`$`$`$`$  /`$`$  /`$`$`$`$`$`$  /`$`$`$`$`$`$   /`$`$`$`$`$`$`$| `$`$`$`$`$`$`$   /`$`$`$`$`$`$  "
    Write-Host "           |  `$`$`$`$`$`$  /`$`$__  `$`$| `$`$ /`$`$__  `$`$|____  `$`$ /`$`$_____/| `$`$__  `$`$ |____  `$`$ "
    Write-Host "            \____  `$`$| `$`$  \__/| `$`$| `$`$  \__/ /`$`$`$`$`$`$`$| `$`$      | `$`$  \ `$`$  /`$`$`$`$`$`$`$ "
    Write-Host "            /`$$  \ `$`$| `$`$      | `$`$| `$`$      /`$`$__  `$`$| `$`$      | `$`$  | `$`$ /`$`$__  `$`$ "
    Write-Host "           |  $`$`$`$`$`$/| `$`$      | `$`$| `$`$     |  `$`$`$`$`$`$`$|  `$`$`$`$`$`$`$| `$`$  | `$`$|  `$`$`$`$`$`$`$ "
    Write-Host "            \______/ |__/      |__/|__/      \_______/ \_______/|__/  |__/ \_______/ "
    Write-Host ""
    Write-Host "                              /`$`$`$`$`$`$`$`$                  /`$`$                         "
    Write-Host "                             |__  `$`$__/                 | `$`$                         "
    Write-Host "                                | `$`$  /`$`$`$`$`$`$   /`$`$`$`$`$`$ | `$`$                         "
        ...
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="{MainBackgroundColor}" ShowGridLines="False" Name="WPFMainGrid">
                ...
                <DockPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="50" Width="100" Name="WPFIcon" SnapsToDevicePixels="True" Source="https://miro.medium.com/v2/resize:fit:1358/1*i2MeHNqKvmnPpqBUzZQf3w.jpeg" Margin="0,10,0,10"/>
                    ...
                    <Button Content="Activator" HorizontalAlignment="Left" Height="40" Width="100" 
                ...
                <TabControl Grid.Row="1" Padding="-1" Name="WPFTabNav" Background="#222222">
                    ...
                    <TabItem Header="Activator" Visibility="Collapsed" Name="WPFTab5">
                        <Grid Background="#555555">
                            <Grid.ColumnDefinitions>
                                <ColumnDefinition Width="*"/>
                            </Grid.ColumnDefinitions>
                            <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Column="0" Margin="10,5">
                                <Button Name="WPFActivator" FontSize="16" Content="Run Windows Activator" Margin="20,4,20,10" Padding="10"/>
                                <TextBlock Margin="20,0,20,0" Padding="10" TextWrapping="WrapWithOverflow" MaxWidth="300"><LineBreak/><LineBreak/> A Windows and Office activator using HWID / KMS38 / Online KMS activation methods, with a focus on open-source code and fewer antivirus detections. </TextBlock>
                            </StackPanel>
